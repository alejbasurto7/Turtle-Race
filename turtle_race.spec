...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('assets/lawn.jpg', 'assets'), ('assets/midi/*.mid', 'assets/midi'), ('assets/snakes/*.png', 'assets/snakes'), ('assets/tracks/*.png', 'assets/tracks'), ('assets/turtles/*.jpg', 'assets/turtles')],
